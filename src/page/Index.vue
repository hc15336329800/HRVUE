		...
		<main class="main-content">
			...
			<section class="banner-section">
				<section class="banner">
					<Swiper class="banner-swiper" :modules="swiperModules" :loop="true" :autoplay="autoplayOptions"
			...
			<section class="company-overview"
				style="display:flex;gap:20px;align-items:stretch;max-width:1080px;margin:24px auto 0;">
				<!-- 左：公司图片 -->
				<div class="co-left" style="flex:0 0 48%;"><img :src="company.img" alt="公司图片"
				...
				<div style="flex:1;display:flex;flex-direction:column;">
					<!-- 简介 -->
					<div
						style="background:#fff;border:1px solid #eee;border-radius:4px;padding:12px 14px;line-height:1.8;">
					...
					<div style="margin-top:10px;border-radius:4px;overflow:hidden;border:1px solid #eee;">
						<div v-for="(row,i) in productLines" :key="i"
							:style="{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'10px 12px',background:i%2? '#f6fff6':'#fff',borderTop:i? '1px solid #f0f0f0':'',fontSize:'14px'}">
			...
			<section class="products">
				<!-- <h2>产品展示</h2> -->
				<!-- 跑马灯（Swiper） -->
				<Swiper class="prod-marquee" :modules="swiperModules" :loop="true" :autoplay="prodAutoplay"
					:speed="1500" :allow-touch-move="true" slides-per-view="auto" :space-between="16">
...
<style scoped>
	...
	@media (max-width: 768px) {
		...
		.banner :deep(.swiper-pagination-bullets) {
	...
	.prod-marquee :deep(.swiper-wrapper) {
	...
	.prod-marquee :deep(.swiper-slide) {
	...
	@media (max-width: 768px) {
		...
		.products :deep(.swiper-button-next) {
			display: none !important;
		}

		.products :deep(.swiper-pagination-bullet) {
			width: 6px;
			height: 6px;
			margin: 0 2px;
		}
